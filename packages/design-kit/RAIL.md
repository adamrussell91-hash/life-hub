...
- No logo, concentric mark, hub tile, or stacked `<br>` wordmark beside or above the brand. The website tile lives beside the page title and on sign-in (`ICONS.md`).
