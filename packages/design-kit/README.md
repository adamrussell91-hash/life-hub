...
| `motion.css`, `morphing-popover.css`, `hub-compose.css`, `adaptive-slider.css`, `card-swipe.css`, `js/*` | Shared motion / morph / compose / slider / swipe deck / date / mobile mount. Closed-field chips: `createMorphingClosedFieldPopover` |
