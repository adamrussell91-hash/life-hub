...
| Sources | Pills 12px/500, 8px square in the source stripe colour. Corey uses the two-ring mark and peach ink. Ambient pill: dashed border, muted, counts of logs (never records). |
