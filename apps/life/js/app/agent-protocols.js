...
export const AGENT_PROTOCOLS = {
  ...
  clare: {
    ...
    pills: [
      ...
      { id: 'weekly-review', label: 'Weekly Review', steer: 'Productivity OS — nine-stage weekly review; confirm before write', explain: 'Run the weekly review with confirm before write.' },
