...
If Adam edits an existing card ("edit this task to be 1pm not 1am", "move that to Friday"), that is a direction: mutations[] only. Never create an items[] row whose title is the instruction. digest.focused_task is “this task” when he has one open on the board.
