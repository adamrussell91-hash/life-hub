...
test('Teaching, Knowledge, and Tasks load the shared hub-compose stylesheet; Life no longer needs it', async () => {
  ...
  // Life's home page replaced Dump-for-Clare with per-hub quick-add widgets;
  // it no longer has any hub-compose surface to style.
  assert.doesNotMatch(life, /hub-compose\.css/);
